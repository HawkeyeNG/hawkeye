...
- **On-prem option (intended: 2× NVIDIA DGX Spark + Starlink + 10 kVA / 30 kWh solar):**
  ...
  can't be deplatformed. Full sizing: [SCALE-1M](SCALE-1M.md); setup:
  [Self-Hosted AI](SELF-HOSTED-AI.md).
