...
const CACHE = 'hawkeye-v184'; // bump on any shell change so installed clients refresh
...
const SHELL = ['/', '/index.html', '/observe.html', '/profile.html', '/how.html', '/faq.html', '/guide.html', '/collation.html', '/integrity.html', '/incidents.html', '/osun.html', '/races.html', '/incident-reports.html', '/practice.html', '/practice.js?v=4', '/race.html', '/race.js?v=6', '/race.css?v=1', '/app.js?v=132', '/scan.js?v=3', '/scan-worker.js?v=3', '/device.js', '/menu.js?v=137', '/authgate.js?v=2', '/webpush.js?v=1', '/tg.js?v=95', '/styles.css?v=136', '/manifest.webmanifest', '/dashboard.html', '/results.html', '/about.html', '/support.html', '/candidates.html', '/political.html', '/privacy.html', '/logo.svg', '/fonts/inter-400.woff2', '/fonts/inter-500.woff2', '/fonts/inter-600.woff2', '/fonts/inter-700.woff2'];
