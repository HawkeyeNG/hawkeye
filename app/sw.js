...
const CACHE = 'hawkeye-v138'; // bump on any shell change so installed clients refresh
...
const SHELL = ['/', '/index.html', '/observe.html', '/profile.html', '/how.html', '/faq.html', '/guide.html', '/collation.html', '/integrity.html', '/incidents.html', '/osun.html', '/practice.html', '/practice.js?v=1', '/race.html', '/race.js?v=3', '/race.css?v=1', '/app.js?v=120', '/scan.js?v=3', '/scan-worker.js?v=3', '/device.js', '/menu.js?v=114', '/tg.js?v=95', '/styles.css?v=112', '/manifest.webmanifest', '/dashboard.html', '/results.html', '/about.html', '/candidates.html', '/political.html', '/privacy.html', '/logo.svg', '/fonts/inter-400.woff2', '/fonts/inter-500.woff2', '/fonts/inter-600.woff2', '/fonts/inter-700.woff2', '/fonts/lora-600.woff2', '/fonts/lora-700.woff2'];
